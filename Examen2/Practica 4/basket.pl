...
writeClauses(MaxCost):-
    ...
    eachTeamAgainstAnotherExactlyOneRound,
    defineHome,
    defineDouble,
    noTriplets,
    noDoublesOnCertainRounds,
    eachRoundOneAtLeastOneMatchBetweenTvTeams,
    teamCanNotPlayAtHome,
    maxCost(MaxCost),
    true,!.
writeClauses(_):- told, nl, write('writeClauses failed!'), nl,nl, halt.

teamCanNotPlayAtHome:- team(T), away(T,R), writeClause([\+home-T-R]), fail.
teamCanNotPlayAtHome.

eachRoundOneAtLeastOneMatchBetweenTvTeams:- round(R),
